<template>
  <div class="bg-primary py-5 text-white d-flex flex-column align-items-center">
    <div>
      ...
      <div class="d-flex flex-row justify-content-between px-4 fs-4 gap-5">
        <a v-for="(link, i) in menuItems" :key="i" :href="link.link" class="link-item text-decoration-none text-white d-inline-block">
          {{link.item}}
        </a>
      </div>
